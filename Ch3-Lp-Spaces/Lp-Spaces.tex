...
\begin{theorem}\textbf{Teorem 3.2}
    Let $\phi : \left( a,b \right) \rightarrow \mathbb{R}$ be a convex function with $a,b \in [-\infty,\infty]$ then $\phi$ has later derivatives on every point in $ \left( a,b \right) $.
