...
\begin{exercise}\textbf{Exercise 17.}
   We start by looking at the case in which $1 \le  p < \infty$ and $\alpha$, we want to see that
   \begin{equation}
...
\begin{exercise}\textbf{Exercise 23.}
    ...
    Observing that $0 < n < n+1 < n+2 < \infty$ and that $2n = \left( n+1 \right) + \left( n+2 \right) $ we can use the observation presented at the end of Ex4 and we have,
    \[
        \|f\|_n^n \le \sqrt{\|f\|_{n+1}^{n+1} \|f\|_{n+2}^{n+2}}  
    \]
